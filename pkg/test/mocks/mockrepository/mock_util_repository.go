...
func (r *MockRepositoryUtil) GetSubcuentasByIdCuenta(id uint) (subcuentas []entities.Subcuenta, erro error) {
	return
}

func (r *MockRepositoryUtil) GetCorreosTelcoRepository() (correos []entities.TelcoCorreo, erro error) {
	args := r.Called()
	return args.Get(0).([]entities.TelcoCorreo), args.Error(1)
}
