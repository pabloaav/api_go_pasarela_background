...
func (mock *MockStoreService) GetObjectSpecific(bucketName string, objectKey string, directorio string) (err error) {
	args := mock.Called(bucketName, objectKey, directorio)
	return args.Error(1)
}
