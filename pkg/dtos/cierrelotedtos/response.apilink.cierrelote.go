...
type ResponseApilinkCL struct {
	...
	PagoInformado        linkdtos.PagoInformado     `json:"pago_informado"`
...
func (apilinkcl *ResponseApilinkCL) EntityToDto(entityApilinkCL entities.Apilinkcierrelote) {
	...
	if entityApilinkCL.Pagoinformado == true {
		apilinkcl.PagoInformado = "Informado"
	} else {
		apilinkcl.PagoInformado = "No informado"
	}
